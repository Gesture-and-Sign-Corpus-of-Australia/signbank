...
defmodule SignbankWeb.CoreComponents do
  ...
  attr :row_link, :any,
    default: nil,
    doc: "function which takes a row and returns a url; do not use with row_click"
    ...
    <table class="table table-zebra">
      ...
      <tbody id={@id} phx-update={is_struct(@rows, Phoenix.LiveView.LiveStream) && "stream"}>
        <tr
          ...
          class={@row_click && "hover:cursor-pointer hover:bg-base-300"}
        >
  ...
  def modal(assigns) do
    ...
    <div>
      ...
      <dialog id={@id} class="modal modal-bottom md:modal-middle">
        <div class={["modal-box !max-w-none w-full min-h-8/10 md:min-h-[unset] md:w-4/5", @div_class]}>
